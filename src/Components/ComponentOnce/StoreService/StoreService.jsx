...
const StoreService = () => {
  const [boxItem, setboxItem] = useState(
    [
      { title: 'آزمون', icon: <img src="../../../../public/images/icon/test.svg" className='w-[4.557291666666667vw] h-[4.557291666666667vw] absolute left-0 top-[-2.6041666666666665vw] opacity-60'/>, key: 1 },
      { title: 'مشاوره', icon: <img src="../../../../public/images/icon/moshavere.svg"  className='w-[4.557291666666667vw] h-[4.557291666666667vw] absolute left-0 top-[-2.6041666666666665vw]  '/>, key: 2 },
      { title: 'فرصت های شغلی', icon: <img src="../../../../public/images/icon/jobs.svg" className='w-[4.557291666666667vw] h-[4.557291666666667vw] absolute left-0 top-[-2.6041666666666665vw] opacity-60'/>, key: 3 },
      { title: 'دوره های تخصصی', icon: <img src="../../../../public/images/icon/course.svg" className='w-[4.557291666666667vw] h-[4.557291666666667vw] absolute left-0 top-[-2.6041666666666665vw] opacity-60'/>, key: 4 },
    ]
  );
  ...
  return (
    <div className=' max-[714px]:w-[66%] max-[570px]:w-[50%]  max-[714px]:scale-150 max-[570px]:scale-[200%] max-[570px]:mt-[39vw]  max-[714px]:mt-[30vw] m-auto w-[100%] mt-[5.786458333333332vw] bg-transparent z-10 relative text-center'>
