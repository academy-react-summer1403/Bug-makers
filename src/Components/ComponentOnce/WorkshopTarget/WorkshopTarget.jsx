  ...
  const targets = [
    {
      ...
      icon: <BsPersonUp className='block w-[8vw] h-[8vw] ' />
    },
    {
      id: 2,
      ...
      icon: <FaMoneyBillTrendUp className='block w-[8vw] h-[8vw]' />
    },
    {
      id: 3,
      ...
      icon: <PiChalkboardTeacherThin className='block w-[8vw] h-[8vw] mt-[1vw]' />
    },
    {
      id: 4,
      ...
      icon: <PiPersonSimpleRun className='block w-[8vw] h-[8vw] ' />
    },
  ];
      ...
      <div className='flex flex-wrap flex-col gap-[10vw] w-[100%] relative'>
        {targets.map((target, index) => (
          <motion.div
            ...
            ${selectedButton === 1 && index === 0 ? 'absolute right-[50.110vw] top-[19.10vw] ' : ''}
            ${selectedButton === 1 && index === 1 ? 'absolute left-[50.110vw] top-[41.10vw] ' : ''}
            ${selectedButton === 1 && index === 2 ? 'absolute right-[50.110vw] top-[64.110vw] ' : ''}
            ${selectedButton === 1 && index === 3 ? 'absolute left-[50.110vw] top-[85.110vw] ' : ''}
          ...
          >
            ...
            <motion.h3 
              className={`text-[1.5625vw] mt-[3vw] indent-[3vw] ${index === 0 ? 'text-right indent-[8vw]' : ''}`} 
              variants={itemVariants}
              initial="hidden"
              whileInView="visible"
