...
const BDetailCenter =({id})=>{
        ...
        const onSubmit=async (val)=>{
            ...
            res.success?alert("نظر شما با موفقییت ثبت گردید و پس از تایید ادمین به نمایش در میاید"):alert("لطفا ابتدا وارد شوید")
        ...
        <div className=" w-[60%] h-max">
            ...
            <div className="relative bg-white w-full h-max  p-[0.26vw] mt-[0.78vw] rounded-[0.94vw] shadow-[0_0.26vw_0.26vw_0_rgba(0,0,0,0.2)] text-right">
                ...
                <div className="text-[#555] w-full p-[1vw] mt-[2vw]">
                    <p className="leading-[1.5vw] min-h-[6vw] w-full text-[0.8vw] break-words whitespace-normal">{response.describe}</p>
                </div>
                ...
                <div className="text-[0.8vw] gap-[1.5vw] text-gray-800 w-full h-[1.46vw] px-[1vw] flex justify-end">
                    <div className="flex justify-evenly h-full w-[7%] items-center">
                        ...
                        <svg className="cursor-pointer"  onClick={()=>{response.currentUserIsLike ? delLikeNews2() :setNewsLike()} } width="1.51vw" height="1.3vw" viewBox="0 0 29 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
                    ...
                    <div className="flex justify-evenly h-full w-[7%] items-center">
                        ...
                        <svg onClick={()=>{response.currentUserIsDissLike ? delLikeNews2() :setNewsDissLike()} } className="cursor-pointer" width="1.51vw" height="1.3vw" viewBox="0 0 29 25" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <BComment GetComment={GetComment} onSubmit={onSubmit} userId={userId} comment={comment} newsId={newsId}/>
