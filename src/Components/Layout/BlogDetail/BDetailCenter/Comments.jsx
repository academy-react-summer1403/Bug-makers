...
<div className="p-[0.1vw] py-[1vw] border-b-[0.15vw] border-[#C2C2C2]  bg-white flex items-start justify-between h-full w-full ">
        <div className=" size-[3vw] ml-[1vw] rounded-[0.42vw] bg-gradient-to-b from-[#C4CDD5] to-[#F2F2F2]"></div>
    <div className="w-[95%] text-right">
      {/* Header: نام نویسنده، تاریخ، ساعت */}
        <div className="flex justify-between items-center mb-2">
        <div className="text-[0.7vw] text-[#5E5E5E] flex justify-between w-[45%]">
    ...
    <div className="text-sm text-gray-700 mt-[1vw] h-[4vw]">
        متن مرتبط با نظرات دوره لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ. لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ.
    </div>

      {/* Footer: دکمه‌های پاسخ دادن و مشاهده پاسخ‌ها */}
    <div className="flex justify-between items-center">
        
        <button className="text-[0.7vw] bg-[#F6F6F6] text-gray-500 hover:text-gray-900 rounded-[0.78vw] w-[6.5vw] h-[1.7vw] p-0">
            مشاهده پاسخ ها (6)
        </button>
        <div className="w-[30vw] h-[1.7vw] rounded-[0.7vw] bg-[#F6F6F6] text-[0.7vw] flex items-center px-[1vw]">
            <span className="overflow-hidden text-ellipsis ...">
                در پاسخ به نویسنده اول: متن شماره یک با نظرات دوره لورم ایپم
            </span>

        </div>
        <button className="flex justify-evenly items-center text-[0.7vw] bg-[#F6F6F6] text-gray-500 hover:text-gray-900 rounded-[0.78vw] w-[5vw] h-[1.7vw] p-0">
            <span>پاسخ دادن</span>
