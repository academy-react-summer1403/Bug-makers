...
const Comments = ({
    ...
    pictureAddress,newsId,userId,parentId,currentUserLikeId,GetComment,renderCourses,onSubmit,
}) => {
    ...
    return (
        ...
        <div className="p-[0.1vw] py-[1vw] border-b-[0.15vw] border-[#C2C2C2]  bg-white flex items-start justify-between h-full w-full ">
            ...
            <div className="flex justify-between items-center mb-2">
                ...
                <span>۲۵ اردیبهشت ۱۴۰۳ </span>|<span>ساعت ۱۶:۲۴ </span>
                ...
                <div className="flex justify-evenly h-full w-[25%] items-center">
                    ...
                    <svg
                    onClick={() => {
                        currentUserIsDissLike ? delLikeNews2() : setNewsDissLike();
                    }}
                    className="cursor-pointer"
                    width="1.51vw"
                    height="1.3vw"
