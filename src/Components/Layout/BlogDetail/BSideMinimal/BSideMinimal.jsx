    ...
    return (
      ...
      >
        <div
          ...
          className="absolute top-[5.73vw] left-[0.89vw] w-[4.557291666666667vw] h-[1.6276041666666667vw]  rounded-full text-center text-[0.590625vw] leading-[1.5vw] "
        >
          {cat}
        </div>
        <div className="flex h-full w-full flex-col overflow-hidden rounded-[0.78vw]">
          ...
          <div className="relative w-full h-[13.13vw] p-[0.21vw] flex flex-col justify-between text-right">
            <div>
              <div className="text-[#5E5E5E] font-[600] h-[2.6vw] text-[1.0416666666666667vw] mt-[0.52vw] w-full overflow-hidden text-ellipsis...">
                {title}
              </div>
              <p className="text-[#9A9A9A] font-[400] leading-[0.78vw] text-[0.7161458333333334vw]  line-clamp-3 overflow-hidden text-ellipsis...">
                {desc}
              </p>
