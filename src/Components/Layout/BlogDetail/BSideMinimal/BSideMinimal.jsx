    ...
    <div onClick={()=>{navigator(`/BlogDetail/${id}`)}} className="shadow-[-0.78vw_0.78vw_0.78vw_0_#0000000D] w-full h-[18.19vw] bg-white rounded-[0.78vw]  overflow-hidden relative p-[0.16vw] cursor-pointer ">
        ...
        <div className="flex h-full w-full flex-col overflow-hidden rounded-[0.78vw]">
            ...
            <div className="relative w-full h-[13.13vw] p-[0.21vw] flex flex-col justify-between text-right">
                <div>
                    <div className="text-[#5E5E5E] font-[600] h-[2.6vw] text-[1.0416666666666667vw] mt-[0.52vw] w-full overflow-hidden text-ellipsis...">{title}</div>
                    <p className="text-[#9A9A9A] font-[400] leading-[0.78vw] text-[0.7161458333333334vw]  line-clamp-3 overflow-hidden text-ellipsis...">{desc}</p>
                    <div className="mt-[0.94vw] w-full h-[3vw] flex items-center justify-between flex-row">
                        <div className="w-[35%] h-full flex justify-between items-center">
                            <div className="size-[1.82vw] rounded-[0.42vw] min-w-[2.2786458333333335vw] h-[2.2786458333333335vw] bg-gray-300 overflow-hidden">
                                <img className="w-[2.2786458333333335vw] h-[2.2786458333333335vw]" onError={(e) => {e.target.src = img2}} src={userImg ? userImg : img2} alt="" />    
                            </div>  
                            <span className="w-[3.23vw] indent-1 text-[#8A8A8A]  whitespace-nowrap font-[400] text-[0.7161458333333334vw]">{writer}</span>
                        </div>  
                        <BlogLikeSvg like={like} comment={comment}/>
                    </div> 
                    <div className="flex justify-between mt-[1vw] items-center text-gray-500 text-[0.63vw]">
