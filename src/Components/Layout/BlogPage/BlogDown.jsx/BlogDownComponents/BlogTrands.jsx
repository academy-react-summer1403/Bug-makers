...
const BlogTrands = () => {
  return (
    ...
    <div className="w-full h-[4.1vw] flex items-center justify-between bg-white mt-[0.47vw]">
        <div className="size-[3.39vw] bg-gray-200 rounded-[0.42vw]"></div>

        <div className="flex-grow h-full pr-[0.42vw]">
            <div className="h-1/2 w-full">
                <span className="text-gray-800 text-[0.85vw]">عنوان خبر</span>
            </div>
            <div className="h-1/2 w-full flex justify-between">
                <div className="text-gray-400 text-[0.6vw] mt-[0.42vw]">۲۵ اردیبهشت ۱۴۰۳</div>
