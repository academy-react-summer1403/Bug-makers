            ...
            <div className="flex items-center justify-between w-[38%]">
              ...
              <div className="flex items-center  text-[0.6vw] justify-center gap-1 w-1/3">
                ...
                >
                  ...
                  />
                  <path
                    d="M5.83691 7.10303H9.83691C10.3892 7.10303 10.8369 6.65531 10.8369 6.10303C10.8369 5.55074 10.3892 5.10303 9.83691 5.10303H5.83691C5.28463 5.10303 4.83691 5.55074 4.83691 6.10303C4.83691 6.65531 5.28463 7.10303 5.83691 7.10303Z"
                    fill="#8A8A8A"
                  />
                  <path
                    d="M12.3687 8.00879H5.96718C5.52525 8.00879 5.16699 8.4565 5.16699 9.00879C5.16699 9.56107 5.52525 10.0088 5.96718 10.0088H12.3687C12.8106 10.0088 13.1689 9.56107 13.1689 9.00879C13.1689 8.4565 12.8106 8.00879 12.3687 8.00879Z"
                    fill="#8A8A8A"
                  />
                  <path
                    d="M12.3687 10.9146H5.96718C5.52525 10.9146 5.16699 11.3623 5.16699 11.9146C5.16699 12.4668 5.52525 12.9146 5.96718 12.9146H12.3687C12.8106 12.9146 13.1689 12.4668 13.1689 11.9146C13.1689 11.3623 12.8106 10.9146 12.3687 10.9146Z"
                    fill="#8A8A8A"
                  />
                </svg>
              </div>
