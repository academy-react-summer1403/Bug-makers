...
const MinimalBlog = () => {
    ...
    <div className="w-[212px] h-[262px] bg-white rounded-[15px] shadow-md overflow-hidden relative p-[3px]">
        <div className="absolute top-[74px] left-[17px] w-[70px] h-[25px] bg-gray-200 rounded-full text-center text-[11px] leading-[20px] text-black">دسته بندی</div>
        ...
        <div className="w-full bg-gradient-to-r from-blue-200 rounded-[15px] to-blue-100 flex items-center justify-center">
            <div className="w-full h-[83px] text-white text-5xl font-bold rounded-[11px]">تصویر</div>
        </div>
        <div className="relative w-full h-[252px] px-[4px] flex flex-col justify-between text-right">
        <div>
            <div className="text-gray-900 font-bold h-[19px] text-[16px] mt-[4px]">عنوان خبر</div>
            <p className="text-gray-600 font-[400] leading-[15px] text-[11px] mt-[8px] max-h-[39px]">توضیحات خبر یا مقاله متن مرتبط با توضیحات دوره لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ.</p>
            ...
            <span className="text-[10px] font-[400]">۲۵ اردیبهشت ۱۴۰۳</span>
            |
            <span className="text-[10px] font-[400]">۳ روز پیش</span>
