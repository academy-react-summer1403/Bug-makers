...
const BlogLastComment = () => {
    ...
    <div
      style={{ background: dark.bgHigh , borderColor:dark.bgLow , color: dark.textHigh }}
      className="shadow-3xl mt-[0.73vw] p-[0.1vw] h-[3.25vw] w-full border-[0.1vw]  rounded-tl-[0.52vw] rounded-tr-[1.04vw] rounded-br-[0.52vw] rounded-bl-[1.04vw] "
    >
      ...
      <div className="inline-block w-[85%] h-full relative top-[-0.4vw]">
        <div className="flex justify-between p-[0.21vw] w-full">
          <p className=" font-[600] text-[0.7vw] ">
            نام نویسنده نظر در عنوان خبر{" "}
          </p>
          <div className="flex justify-between items-center mt-[0.4vw] w-[4.17vw]">
            <span className="text-[0.6vw] font-[400] ">
              {" "}
              ۴ دقیقه پیش
            </span>
            <svg
