      ...
      <div className="flex h-[100%] w-[100%] gap-x-2 justify-between items-center">
        {menuItems.map((item) => (
          <div
            ...
            className={`flex items-center text-bold text-[0.9vw] justify-center rounded-full max-w-[100px] w-[24%] h-[100%] hover:border-[#E1C461] ${
              activeIndex === item.id
        ...
        >
          ...
          >
            <path
              ...
              stroke={overmenu == true ? "#FEFDFF" : "#272727"}
              stroke-width="1.5"
            />
            <path
