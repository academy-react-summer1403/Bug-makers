    ...
    >
      ...
      <h2
        className={`absolute  text-[16px] font-semibold  text-right ${
          listStyle ? "top-7 right-3" : "top-[168px] "
        }`}
      >
        {title}
      </h2>
      <span
        className={`text-[14px] text-[#5E5E5E] absolute top-16 right-3 ${
      ...
      <div
        className={`flex justify-center items-center gap-20 flex-nowrap w-[480px] absolute top-40 right-3 ${
      ...
      <div
        className={`absolute t h-[40px]  flex flex-row gap-2 justify-center items-center ${
          listStyle ? "top-56 right-3" : "top-[261px] left-[15px]"
        }`}
      >
        <span className="text-[11px] text-[#8A8A8A]">{teacherName}</span>
        <span
          className={`text-[9px] text-[#8A8A8A] absolute bottom-0 right-12 ${
            listStyle ? "block" : "hidden"
          }`}
        >
          12دوره فعال
        ...
        <img
          src=""
          className={`h-[40px] w-[40px] bg-drop-gradient shadow-drop-shadow  ${
            listStyle ? "rounded-[10px]" : "rounded-[100%]"
          } `}
        />
      </div>
      <h2
        className={` w-[180px] h-[35px] rounded-[8px] absolute top-[229px] right-80 text-[16px] text-center bg-register-course text-white leading-8 ${
          listStyle ? "block" : "hidden"
        }`}
      >
        ثبت نام در دوره
      ...
      <div
        dir="rtl"
        className={`absolute h-[24px]  flex flex-row gap-1 justify-center items-center ${
          listStyle ? "top-[276px] right-10" : "top-[308px] left-[15px] "
        }`}
      >
        <img
          src="../../../../public/Image/Icon/calendar.png"
          className={` ${
            listStyle ? "w-[15px] h-[15px]" : "w-[24px] h-[24px]"
          }`}
        />
      ...
      <div
        ...
        className={`absolute h-[24px]  flex flex-row gap-2 justify-center items-center ${
          listStyle ? " top-[276px] right-[415px]" : " top-[343px] left-[15px]"
        }`}
      >
      ...
      <div
        className={` bg-[#f2eefb] absolute  h-[1px] ${
          listStyle
            ? "top-[310px] right-3 w-[42%]"
            : "top-[371px] left-0 w-[100%]"
        }`}
      ></div>
      <div
        className={`h-3 w-3 rounded-[100%]  absolute top-[305px] right-2 ${
          listStyle ? "block" : "hidden"
        }`}
      ></div>
      <div
        ...
        className={`flex flex-nowrap items-center justify-center absolute ${
          listStyle
            ? "gap-24  top-[320px] right-10"
            : "gap-8  top-[380px] right-10"
        }`}
      >
        <div
          className={`w-[40px] h-[17px] flex flex-row justify-center items-center gap-2 text-[11px] text-[#8A8A8A] ${
            listStyle ? "block" : "hidden"
          }`}
        >
          <span>کاربر</span>
