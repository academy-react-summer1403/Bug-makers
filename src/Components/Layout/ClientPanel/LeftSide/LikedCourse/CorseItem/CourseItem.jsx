  ...
  return (
    ...
    >
      <div className="h-[1.8vw] w-full text-right flex justify-between items-center mb-[0.5vw]">
        ...
        >
          <span className="text-red-500 text-[0.9vw] mb-[0.3vw]">بستن</span>
          <svg
            width=""
            height="80%"
            viewBox="0 0 24 24"
      ...
      >
        <Tooltip
          className="text-gray-700 break-words w-[300px] max-md:w-[100px] text-[0.9vw] leading-[1.4vw]"
          size="sm"
          content={`${description}`}
        >
          {description}
      ...
      <div className="w-full h-[1.4vw] text-[0.9vw] flex gap-x-[0.2vw] font-[600] mt-[0.5vw]">
        <svg
          className="ml-[0.5vw]"
          width=""
          height="100%"
