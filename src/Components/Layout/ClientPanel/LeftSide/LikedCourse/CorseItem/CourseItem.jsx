...
import Skeleton2 from "../../../../../Common/Sceleton/Skeleton";
 ...
 ${
   response?.isCourseReseve == 1
     ...
     : "bg-[#E1C461] hover:bg-[#E1C461]"
          ...
          >
            <Tooltip
              className="text-gray-700 max-w-[400px] max-h-[200px] overflow-hidden text-ellipsis ... text-[0.8vw] break-words w-[25vw] leading-[1.4vw]"
              size="sm"
              content={` ${description}`}
            >
              {description}
