    ...
    <>
              ...
              <div className="flex justify-evenly h-full w-[25%] items-center">
                ...
                >
                  <path
                    ...
                    fill={like == true ? "red" : "#7F7F7F"}
                  />
                </svg>
              </div>
              |
              <div className="flex justify-evenly h-full w-[25%] items-center">
                <span>{like == false ? 5 : 4}</span>
                <svg
                  onClick={() => {
                    setTimeout(() => {
                      setLike(false);
      ...
      >
        <div
          className={
            repleyModal
              ? "h-max max-md:w-full max-md:max-w-full max-md:h-[30%] w-[90vw] max-w-[50vw] rounded-[1vw] bg-white z-40"
              : "hidden"
          }
