...
const CourseItem = ({ 
  ...
  return (
    <div onClick={handleNavigate} dir={`${listStyle ? 'ltr' : 'rtl'}`}  className={`relative shadow-[-15px_15px_15px_0px_#0000000D] bg-white rounded-2xl p-[5px] overflow-hidden group hover:scale-110 cursor-pointer transition-all duration-300  ${listStyle ? 'w-[100%]  h-[22.786458333333332vw]' : 'w-[250px]  h-[405px]   '}`}>
        ...
        <img src={img ? img : img2} onError={(e) => {e.target.src = img2}}  className={` bg-poster rounded-[11px] ${listStyle ? 'w-[35.807291666666664vw] h-[22.135416666666668vw]' : 'w-[100%] h-[147px]'}`} />
        ...
        <div dir='rtl' className={`absolute h-[1.5625vw]  flex flex-row gap-1 justify-center items-center ${listStyle ? 'top-[17.96875vw] right-[2.6041666666666665vw]' : 'top-[308px] left-[15px] '}`}>
            <img src='../../../../public/images/icon/calendar.png' className={` ${listStyle ? 'w-[0.9765625vw] h-[0.9765625vw]' : 'w-[24px] h-[24px]'}`} />
        ...
        <div dir='rtl' className={`absolute h-[24px]  flex flex-row gap-2 justify-center items-center ${listStyle ? ' top-[17.96875vw] right-[27.018229166666668vw]' : ' top-[343px] left-[15px]'}`}>
            ...
            <img src='../../../../public/images/icon/toman.png'  />
        </div>
        ...
        <div dir='ltr' className={`flex flex-nowrap items-center justify-center absolute ${listStyle ? 'gap-[6.25vw]  top-[20.833333333333332vw] right-[2.6041666666666665vw]' : 'gap-8  top-[380px] right-10'}`}>
            ...
            <div className='w-[40px] h-[17px] flex flex-row justify-center items-center gap-2 text-[11px] text-[#8A8A8A]'>
                ...
                <img src='../../../../public/images/icon/comment.png'  />
            </div>
        </div>
    </div>
  )
